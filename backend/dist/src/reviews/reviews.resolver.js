...
let ReviewsResolver = class ReviewsResolver {
    ...
    createReview(createReviewInput, ctx) {
        const userId = this.getUserId(ctx);
...
__decorate([
    (0, graphql_1.Query)(() => [review_entity_1.Review], { name: 'reviewsByListing' }),
    __param(0, (0, graphql_1.Args)('listingId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], ReviewsResolver.prototype, "findAllByListingId", null);
__decorate([
    (0, graphql_1.Query)(() => [review_entity_1.Review], { name: 'myReviews' }),
